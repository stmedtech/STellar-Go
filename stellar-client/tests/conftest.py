"""
Pytest configuration and fixtures for Stellar Client tests.
"""
...
def temp_file():
    ...
    with tempfile.NamedTemporaryFile(mode='w', delete=False, suffix='.txt') as tmp_file:
        tmp_file.write("Test content for Stellar client testing")
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "integration: mark test as integration test (requires running Stellar node)"
    )
    config.addinivalue_line(
