#!/usr/bin/env python3
"""
Stellar Node Verification Script

Quick script to verify if the Stellar node is running and accessible.
"""
...
def test_basic_connection():
    ...
    try:
        ...
        print("❌ stellar_client not installed. Run: pip install -e .")
        return False
...
def provide_setup_help():
    """Provide help on setting up the Stellar node."""
    print("""
📋 Stellar Node Setup Instructions
===============================
...
def main():
    ...
    print("🌟 Stellar Node Verification")
    print("=" * 40)
    ...
    if process_running:
        if connection_ok:
            print("\n🎉 SUCCESS!")
            print("✅ Stellar node is running and accessible")
