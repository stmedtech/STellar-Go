...
This example demonstrates remote compute operations with Stellar client:
...
def create_environment_yaml() -> str:
    ...
    env_content = """name: stellar_demo_env
channels:
  - defaults
  - conda-forge
dependencies:
...
def main():
    print("Stellar Client - Compute Protocol Example")
    print("=" * 40)
    ...
    try:
        with StellarClient() as client:
            ...
            if not devices:
                print("No devices found. Start additional Stellar nodes to test compute operations.")
                return 1
...
print("Hello from remote Stellar device!")
