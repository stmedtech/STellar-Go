"""
Comprehensive Integration Test Suite for DCFL Client
...
Tests are designed to run in sequence and verify the complete DCFL client functionality.
"""
...
from dcfl_client.exceptions import FileTransferError, DeviceNotFoundError, ProtocolError


class TestDCFLIntegrationSuite:
    """Comprehensive integration test suite for DCFL client."""
    
    @pytest.mark.integration
    def test_complete_dcfl_workflow(self):
        """Test complete DCFL workflow across all protocols."""
        try:
