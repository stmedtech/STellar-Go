"""
Test suite for DCFL Client File Protocol

This module tests the file transfer functionality of the DCFL client.
...
class TestFileProtocolIntegration:
    """Integration tests for file protocol (requires running DCFL node)."""
