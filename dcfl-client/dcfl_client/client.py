"""Main DCFL client implementation."""
...
class DeviceContext:
    ...
    def __init__(self, client: 'DCFLClient'):
        self.client = client
...
class DCFLClient:
    """Synchronous DCFL client for communicating with DCFL nodes."""
    
    def __init__(self, socket_path: Optional[str] = None, timeout: int = 30):
        """Initialize DCFL client.
    ...
    def connect(self) -> None:
        """Establish connection to DCFL node."""
        # Connection is established lazily on first request
        pass
        
    def disconnect(self) -> None:
        """Disconnect from DCFL node."""
