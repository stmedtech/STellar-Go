...
This example demonstrates a complete federated learning workflow using DCFL:
...
from dcfl_client.models import CondaEnvConfig, ScriptConfig, FLTaskConfig
...
def main():
    ...
    print(f"Starting DCFL FL Client {client_id}")
    ...
    # Create FL client
    client = DCFLClient(model, train_loader, test_loader, client_id)
...
def main():
    print("Starting DCFL Federated Learning Server")
    
    # Configure FL strategy
    strategy = DCFLStrategy(
...
def main():
    print("DCFL Client - Federated Learning Example")
    print("=" * 50)
    ...
    try:
        with DCFLClient() as client:
            ...
            if len(devices) < 2:
                ...
                print("Starting additional DCFL nodes is recommended for this demo.")
                if len(devices) == 0:
                    return 1
