...
This example demonstrates file operations with DCFL client:
...
from dcfl_client.exceptions import FileTransferError, DeviceNotFoundError
...
def main():
    print("DCFL Client - File Transfer Example")
    print("=" * 40)
    ...
    try:
        with DCFLClient() as client:
            ...
            if not devices:
                print("No devices found. Start additional DCFL nodes to test file transfer.")
                return 1
...
# Uploaded from DCFL Client File Transfer Example
print("Hello from DCFL!")
print("This file was transferred using the DCFL client.")
