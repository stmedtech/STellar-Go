...
def test_echo_protocol():
    ...
    try:
        ...
        with DCFLClient(timeout=120) as client:  # 2 minutes timeout for file operations
            print("✓ Connected to real DCFL node")
...
def test_file_protocol():
    """Test file protocol with real DCFL node including download/upload operations."""
        ...
        with DCFLClient(timeout=120) as client:  # 2 minutes timeout for file operations
            ...
            try:
                ...
                with tempfile.NamedTemporaryFile(mode='w', delete=False, suffix='.txt') as temp_file:
                    ...
                    test_content += "This is a test file for DCFL file upload functionality.\n"
...
def test_smart_client():
    """Test the smart client with real DCFL node."""
...
def run_performance_test():
    """Test performance with real DCFL node."""
    print("\n=== Performance Test ===")
...
def main():
    """Run all protocol tests with real DCFL node."""
    print("DCFL Client - Real Protocol Test Suite")
    print("=" * 50)
    
    print("\nTesting all protocols with real DCFL node...")
    ...
    print("   - All tests use actual DCFL node and discovered devices")
    ...
    if passed_tests == total_tests:
        print("\n🎉 ALL TESTS PASSED! DCFL system is working perfectly.")
        return True
    else:
